...
struct HasAnyErrorPredicate : public std::negation<std::is_same<::voe::ValueOrError<ValueType>, ValueOrError>> {};

template <typename ValueType, typename... ErrorTypes>
using TypesWithErrors =
    list::filter<Types<ValueType, ErrorTypes...>, tpl::bindFront<HasAnyErrorPredicate, ValueType>::template T1>;
...
static_assert(std::is_same_v<Types<void, int>, list::list<voe::VoidOrError<>, voe::VoidOrError<int>>>);
static_assert(
    std::is_same_v<
        Types<void, int, float>,
        list::list<voe::VoidOrError<>, voe::VoidOrError<float>, voe::VoidOrError<int>, voe::VoidOrError<int, float>>>);
static_assert(std::is_same_v<Types<int>, list::list<voe::ValueOrError<int>>>);
static_assert(std::is_same_v<Types<int, float>, list::list<voe::ValueOrError<int>, voe::ValueOrError<int, float>>>);
static_assert(
    std::is_same_v<
        Types<void, int, float>,
        list::list<voe::VoidOrError<>, voe::VoidOrError<float>, voe::VoidOrError<int>, voe::VoidOrError<int, float>>>);
...
static_assert(std::is_same_v<TypesWithErrors<int, float>, list::list<voe::ValueOrError<int, float>>>);
static_assert(std::is_same_v<
              TypesWithErrors<void, int, float>,
              list::list<voe::VoidOrError<float>, voe::VoidOrError<int>, voe::VoidOrError<int, float>>>);
