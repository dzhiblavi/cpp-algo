...
template <typename Container>
class NDContainerView : public NDViewTag<detail::getValueType<Container>, detail::countDimensions<Container>> {
 public:
 ...
 private:
  ...
  using AtResultType =
      std::conditional_t<IndicesCount == NDims, ValueType&, NDContainerView<NDVector<ValueType, NDims - IndicesCount>>>;
